...
# Cluster 1 (Dan, Daisy, Yen-Ling and Qianhui) jumped more on average than Cluster 2 (Amanda, Aniket, Junhao, Xinyuan)
# It is a strong conclusion (for the weak data we have), but Cluster 1 is for Experts and 2 for Novices
...
ggplot(DF4, aes(avgZ, avgJ, colour = cluster)) + geom_point() + xlab("mean(max(Z))") + ylab("mean(Jumps)") + ggtitle("Mean Jumps by Mean max(Y), by cluster")
